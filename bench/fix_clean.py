...
p("bench/agent.py", '"deepseek": "deepseek-chat"', '"deepseek": "deepseek/deepseek-v4-flash"')

# 2. agent.py: pricing
p("bench/agent.py", '"deepseek-chat": {', '"deepseek/deepseek-v4-flash": {')
...
p("bench/agent.py", "ctx = context_get_dirty()", "ctx = _TRACKER.get_dirty()")
